            ...
            <v-card class="content">
                ...
                <v-row wrap>
                    ...
                    <v-col cols="4" style="margin-left: 200px;">
                        ...
                        <v-text-field :append-inner-icon="visible ? 'mdi-eye-off' : 'mdi-eye'"
                            :type="visible ? 'text' : 'password'" prepend-inner-icon="mdi-lock" variant="solo"
                            density="compact" class="donodash-input" rounded
                            @click:append-inner="visible = !visible"></v-text-field>
                ...
                <v-btn size="large" rounded="xl" class="donodash-orange-button">
                    Sign up
                </v-btn>
